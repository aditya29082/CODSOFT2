...
int main() {
    ...
    std::cout << "Hey Buddy Insert your first choice/number: ";
    std::cin >> numA;

    std::cout << "Hey Buddy Insert your second choice/number: ";
    std::cin >> numB;

    std::cout << " Buddy Choose the operation (-, +, /, *): ";
    std::cin >> operation;
    ...
    std::cout << " Buddy your Result is : " << result << std::endl;
